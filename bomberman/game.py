...
while Level<=3:
    ...
    while Timer>=0:
        ...
        if s!=0 and s!='b':
            ...
            if len(b)==2:
                b = b[0]
                print(Fore.RED+"LIFES AVAILABLE : ",Fore.WHITE+str(max_lifes),'\t',Fore.MAGENTA+"YOUR SCORE : ",Fore.WHITE+str(TotalScore+score),'\t',Fore.GREEN+"TIME : ",Fore.WHITE+str(Timer),'\t',Fore.CYAN+"LEVEL :",Fore.WHITE+str(Level))             ##LENGTH OF TWO INDICATES BOMBERMAN COMMITED SUICIDE
                a.PrintBoard(b)
                max_lifes-=1
                Resetflag = 1
                CheckToEnd(max_lifes,enemies)
        ...
        if time.time()>=NextInput:
            ...
            for i in a.enemies:
                ...
                if temp[1] == 3:
                    print(Fore.RED+"LIFES AVAILABLE : ",Fore.WHITE+str(max_lifes),'\t',Fore.MAGENTA+"YOUR SCORE : ",Fore.WHITE+str(TotalScore+score),'\t',Fore.GREEN+"TIME : ",Fore.WHITE+str(Timer),'\t',Fore.CYAN+"LEVEL :",Fore.WHITE+str(Level))                                    ##THE ENEMY KILLED BOMBERMAN
                    a.PrintBoard(b)
                    max_lifes-=1
                    Resetflag = 1
                    if max_lifes == -1:
