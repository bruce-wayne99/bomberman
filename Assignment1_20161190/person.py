class Person():
    def __init__(self, type, lefttop_x, lefttop_y):
        self.type = type
        self._lefttop_x = lefttop_x     # Indicates the top left x-coordinate
        self._lefttop_y = lefttop_y     # Indicates the top left x-coordinate
    ...
    # Used to Populate the Grid with the enemy or bomberman
    ...
    # Used to clear the grid after blast
    ...
    def Move(self, direction, grid, move_type):
        if direction == 'a':
            if self.type == 1 and grid[self.get_lefttop_x()][self.get_lefttop_y(
            ) - 3] == 'E' and grid[self.get_lefttop_x() + 1][self.get_lefttop_y() - 3] == 'E':
                return self.BomberManSuicide('a', grid, move_type)
            if grid[self.get_lefttop_x()][self.get_lefttop_y() -
                                          1] == ' ' or move_type == 3:
        ...
        if direction == 'd':
            if self.type == 1 and grid[self.get_lefttop_x()][self.get_lefttop_y(
            ) + 5] == 'E' and grid[self.get_lefttop_x() + 1][self.get_lefttop_y() + 5] == 'E':
            ...
            if grid[self.get_lefttop_x()][self.get_lefttop_y() +
                ...
                return grid
        if direction == 'w':
            if self.type == 1 and grid[self.get_lefttop_x() -
                                       2][self.get_lefttop_y() +
                                          1] == 'E' and grid[self.get_lefttop_x() -
                                                             1][self.get_lefttop_y() +
                                                                1] == 'E':
                return self.BomberManSuicide('w', grid, move_type)
            if grid[self.get_lefttop_x() - 1][self.get_lefttop_y()
                                              ] == ' ' or move_type == 3:
                grid = self.ClearGridOfPerson(grid, move_type)
        ...
        if direction == 's':
            if self.type == 1 and grid[self.get_lefttop_x() +
                                       2][self.get_lefttop_y() +
                                          1] == 'E' and grid[self.get_lefttop_x() +
                                                             3][self.get_lefttop_y() +
                                                                1] == 'E':
                return self.BomberManSuicide('s', grid, move_type)
            if grid[self.get_lefttop_x() + 2][self.get_lefttop_y()
                                              ] == ' ' or move_type == 3:
                grid = self.ClearGridOfPerson(grid, move_type)
                self.set_lefttop_x(self.get_lefttop_x() + 2)
                self.set_lefttop_y(self.get_lefttop_y())
